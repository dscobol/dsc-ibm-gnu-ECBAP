      ...
      *
       ...
       01  WS-Counters.
           12 WS-Fin-1-Record-Cnt     PIC 9(4) COMP VALUE ZEROES.
           12 WS-Fout-1-Record-Cnt    PIC 9(4) COMP VALUE ZEROES.
           12 WS-Fout-2-Record-Cnt    PIC 9(4) COMP VALUE ZEROES.
       ...
       01  R1-Footer1.
           12 FILLER             PIC X(036)
              VALUE "Number of Proposals in this Report: ".
           12 FILLER             PIC X VALUE SPACE.
           12 R1-Total-Line-Printed PIC ZZ9.

       01 EOJ-Display-Messages.
           12 EOJ-End-Message PIC X(034) VALUE
              "*** Program WS81D - End of Run ***".
       ...
       3000-End-Job.
           MOVE R1-Lines-Written TO R1-Total-Line-Printed.
