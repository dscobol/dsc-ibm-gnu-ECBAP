      ...
      * SOURCE-COMPUTER. IBM WITH DEBUGGING MODE.
       ...
       01  FD-Account-Record.
           ...
           12 FD-Salary                       PIC 9(7)V99 COMP-3.
           12 FD-Net-Worth                    PIC 9(7)V99 COMP-3.
       ...
       01  WS-Program-Storage.
           12 WS-Total-Salary         PIC S9(9)V99 VALUE ZEROES.
           12 WS-Total-Net-Worth      PIC S9(9)V99 VALUE ZEROES.
           12 WS-High-Salary          PIC S9(9)V99 VALUE ZEROES.
           12 WS-High-Salary-Name     PIC X(035)   VALUE SPACES.
           12 WS-Low-Salary           PIC S9(9)V99 VALUE 999999999.99.
           12 WS-Low-Salary-Name      PIC X(035)   VALUE SPACES.

       01  WS-CB-Hold-Storage.
           12 WS-CB-State             PIC X(20)    VALUE SPACES.
           12 WS-CB-Total-Salary      PIC S9(9)V99 VALUE ZEROES.
           12 WS-CB-Total-Net-Worth   PIC S9(9)V99 VALUE ZEROES.
       ...
       01  R1-Footer2.
           ...
           12 FILLER                   PIC X VALUE SPACE.
           12 R1-FT-Highest-Name       PIC X(035).

       01  R1-Footer3.
           12 FILLER                   PIC X(040)
              VALUE "      President with the Lowest Salary: ".
           12 FILLER                   PIC X VALUE SPACE.
           12 R1-FT-Lowest-Name        PIC X(035).
